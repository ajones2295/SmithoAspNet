...
using Mvc.Areas.Visitor.Controllers;
...
namespace Mvc.Areas.Admin.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public AccountController(ILogger<AccountController> logger, UserManager<ApplicationUser> userManager, SignInManager<ApplicationUser> signInManager, IEmailSender emailSender, UrlEncoder urlEncoder, RoleManager<IdentityRole> roleManager)
        {
            _logger = logger;
        ...
        public async Task<IActionResult> Register(RegisterViewModel model, string? returnurl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    await _emailSender.SendEmailAsync(model.Email, "Confirm Email - Identity Manager", "<html><body>" +
                               "<h1>Confirm You Email</h1>" +
                               "<a href=\"" + callbackurl + "\"> please click this link to confirm your email.... </a></p>" +
                               "</body></html>");
        ...
        public async Task<IActionResult> ForgotPassword(ForgotPasswordViewModel model)
        {
            if (ModelState.IsValid)
            {
                ...
                await _emailSender.SendEmailAsync(model.Email, "Reset Password - Identity Manager", "<html><body>" +
                           "<h1>Reset Your Password</h1>" +
                           "<a href=\"" + callbackurl + "\"> please click this link to reset your password.... </a></p>" +
                           "</body></html>");
                return RedirectToAction("ForgotPasswordConfirmation");
            }
            return View(model);
